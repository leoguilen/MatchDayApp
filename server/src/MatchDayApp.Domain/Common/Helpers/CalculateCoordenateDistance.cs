...
{
    public static class CalculateCoordenateDistance
    {
        private const double R = 6371e3;

        public static double CalculeToMeters(double lat1 = 0, double long1 = 0,
        ...
        public static bool IsNear(double lat1 = 0, double long1 = 0, double lat2 = 0, double long2 = 0) =>
            CalculeToMeters(lat1, long1, lat2, long2) > 10000 ? false : true;
    }
}
